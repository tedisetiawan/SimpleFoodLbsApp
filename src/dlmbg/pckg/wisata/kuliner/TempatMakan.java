...
public class TempatMakan extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		Cursor cursor = sqliteDB.bacaDataTempatMakan();
		...
		Button btn_tambah = (Button) findViewById(R.id.btn_tambah_tempat_makan);
